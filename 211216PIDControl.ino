...
#define _DIST_MIN 90 // [2972] 거리 센서가 인식 가능하게 설정한 최소 거리
...
#define _DUTY_NEU 1600 // [2952] 서보의 중간 각도값
#define _DUTY_MAX 2400 // [1691] 서보의 최대 각도

// Servo speed control
#define _SERVO_ANGLE 30  //[2967] 서보 각도 설정
#define _SERVO_SPEED 60  //[2959] 서보의 속도 설정
...
////////////////////
  ...
  if(event_serial) {
    ...
    Serial.print(",P:");
    Serial.print(map(pterm, -1000, 1000, 510, 610));    // [2961] 비례제어량 출력                        // [2959] 적외선 센서로부터 받은 값을 보정한 값 출력
    Serial.print(",D:");
    Serial.print(map(dterm, -1000, 1000, 510, 610));    // [2961] 비례제어량 출력
    Serial.print(",I:");
    Serial.print(map(iterm, -1000, 1000, 510, 610));
    Serial.print(",DTT:");
    Serial.print(map(duty_target, 1000, 2000, 410, 510)); // [2957] 목표로 하는 거리 출력
    Serial.print(",DTC:");
...
float ir_distance_filtered(void){ // return value unit: mm
  ...
  return val; //[2959] 100mm일때 측정값과 400mm일때 측정값
                                            //       기준으로 거리 보정
}
